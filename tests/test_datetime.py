...
@pytest.mark.parametrize(
    ...
    [(date(2011, 4, 30), '"2011-04-30"'), (date(1987, 12, 1), '"1987-12-01"'), (time(12, 32), '"12:32"'),
     (time(12, 32, 23), '"12:32:23"'), (time(12, 32, 23, 345), '"12:32:23.000345"'), (time(12, 32, 0, 1), '"12:32:00.000001"'),
     (time(12, 32, 0, 12), '"12:32:00.000012"'), (time(12, 32, 0, 123), '"12:32:00.000123"'),
     (time(12, 32, 0, 1234), '"12:32:00.001234"'), (time(12, 32, 0, 12345), '"12:32:00.012345"'),
     (time(12, 32, 0, 12340), '"12:32:00.012340"'), (time(12, 32, 0, 12345), '"12:32:00.012345"'),
     ...
     (datetime(2017, 4, 1, 12, 23, 45, tzinfo=TZInfo(-3600)), '"2017-04-01T12:23:45-01:00"'),
     (datetime(2017, 4, 1, 12, 23, 45, 1, tzinfo=TZInfo(-3600)), '"2017-04-01T12:23:45.000001-01:00"'),
     (datetime(2017, 4, 1, 12, 23, 45, 12, tzinfo=TZInfo(-3600)), '"2017-04-01T12:23:45.000012-01:00"'),
     (datetime(2017, 4, 1, 12, 23, 45, 123, tzinfo=TZInfo(-3600)), '"2017-04-01T12:23:45.000123-01:00"'),
     (datetime(2017, 4, 1, 12, 23, 45, 1234, tzinfo=TZInfo(-3600)), '"2017-04-01T12:23:45.001234-01:00"'),
     (datetime(2017, 4, 1, 12, 23, 45, 12345, tzinfo=TZInfo(-3600)), '"2017-04-01T12:23:45.012345-01:00"'),
     (datetime(2017, 4, 1, 12, 23, 45, 123456, tzinfo=TZInfo(-3600)), '"2017-04-01T12:23:45.123456-01:00"'),
     (datetime(2017, 4, 1, 12, 23, 45, 23000, tzinfo=TZInfo(-3600)), '"2017-04-01T12:23:45.023000-01:00"'),
     (datetime(2017, 4, 1, 12, 23, 45, 3, tzinfo=TZInfo(-3600)), '"2017-04-01T12:23:45.000003-01:00"'),
     (datetime(2017, 4, 1, 12, 23, 45, 3, tzinfo=TZInfo(-5400)), '"2017-04-01T12:23:45.000003-01:30"')])
...
@pytest.mark.parametrize("value,expected", [
    ...
    ('"01:01:01"', time(1, 1, 1)),
    ('"01:01:01.123"', time(1, 1, 1, 123000)),
    ('"01:01:01.123456"', time(1, 1, 1, 123456)),
    ('"01:01:01Z"', time(1, 1, 1, 0, timezone.utc)),
    ('"01:01:01.123Z"', time(1, 1, 1, 123000, timezone.utc)),
    ...
    ('"2017-05-13 20:24:23.123"', datetime(2017, 5, 13, 20, 24, 23, 123000)),
    ('"2017-05-13 20:24:23.123456"', datetime(2017, 5, 13, 20, 24, 23, 123456)),
    ('"2017-05-13T20:24:23"', datetime(2017, 5, 13, 20, 24, 23)),
    ('"2017-05-13t20:24:23"', datetime(2017, 5, 13, 20, 24, 23)),
    ('"2017-05-13 20:24:23Z"', datetime(2017, 5, 13, 20, 24, 23, tzinfo=timezone.utc)),
    ('"2017-05-13 20:24:23z"', datetime(2017, 5, 13, 20, 24, 23, tzinfo=timezone.utc)),
    ('"2017-05-13 20:24:23.123Z"', datetime(2017, 5, 13, 20, 24, 23, 123000, tzinfo=timezone.utc)),
    ('"2017-05-13 20:24:23.123+0100"', datetime(2017, 5, 13, 20, 24, 23, 123000, tzinfo=__tz(3600))),
    ('"2017-05-13 20:24:23.123+01:00"', datetime(2017, 5, 13, 20, 24, 23, 123000, tzinfo=__tz(3600))),
    ('"2017-05-13 20:24:23.123-0100"', datetime(2017, 5, 13, 20, 24, 23, 123000, tzinfo=__tz(-3600))),
    ('"2017-05-13 20:24:23.123-01:00"', datetime(2017, 5, 13, 20, 24, 23, 123000, tzinfo=__tz(-3600))),
])
